((function fn(){//     Underscore.js 1.8.3
    var root = this,previousUnderscore = root._, ArrayProto = Array.prototype, ObjProto = Object.prototype,
        FuncProto = Function.prototype,push = ArrayProto.push,   slice = ArrayProto.slice,
        ...
        _ = function(obj) {
            ...
            if (!(this instanceof _)) {return new _(obj)}; this._wrapped = obj;}
    ...
    _.once = _.partial(_.before, 2);_.defer = _.partial(_.delay, _, 1);
    ...
    _.x= _.extend = createAssigner(_.allKeys);_.extendOwn = _.assign = createAssigner(_.keys);_.defaults = createAssigner(_.allKeys, true);
    ...
    function createReduce(dir) {
        function iterator(obj, iteratee, memo, keys, index, length) {for (; index >= 0 && index < length; index += dir) {var currentKey = keys ? keys[index] : index;
                memo = iteratee(memo, obj[currentKey], currentKey, obj) }; return memo;}
    ...
    _group(); escapr(); _template(); resultMixinProto()
    function core() {
        _.iteratee = function (v, ctx) {
            return cb(v, ctx, Infinity)
        }
        _.e = _.each = _.forEach = function (obj, iteratee, ctx) {
        ...
        _.find = _.detect = function (obj, predicate, ctx) {
            var key;
            if (isArrayLike(obj)) {
                key = _.findIndex(obj, predicate, ctx);
            } else {
                key = _.findKey(obj, predicate, ctx);
            }
        ...
        _.pick = function (object, oiteratee, ctx) {
        ...
        _.so = _.some = _.any = function (obj, predicate, ctx) {
            predicate = cb(predicate, ctx);
            var keys = !isArrayLike(obj) && _.keys(obj),
                length = (keys || obj).length;
            for (var index = 0; index < length; index++) {
    ...
    function _group() {var group = function (behavior) {return function (obj, iteratee, ctx) {         var result = {};iteratee = cb(iteratee, ctx);_.e(obj, function (value, index) {var key = iteratee(value, index, obj); behavior(result, value, key) }); return result } }
    ...
    _.e(['pop', 'push', 'reverse', 'shift', 'sort', 'splice', 'unshift'], function(n) {
        ...
        _.prototype[n] = function() {var obj = this._wrapped; method.apply(obj, arguments);
            if ((n === 'shift' || n === 'splice') && obj.length === 0) {delete obj[0]}
    ...
    _.mixin = function(obj){
        _.e(_.functions(obj), function(n) {
            var fn = _[n] = obj[n];
            _.prototype[n] = function(){
...
ob= {
    ...
    RE: _.isRegExp, iE: _.isEmpty, iEq: _.isEqual,
    e: _.each, m:_.map, b:_.bind,
    z: _.size, o:_.once, k: _.keys,
    x:  _.extend, d: _.defaults,
    cl: _.clone,
    so: _.some,
    pk: _.pick,
    uI: _.uniqueId,
