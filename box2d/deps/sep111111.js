...
calcShapes = function (verts) {var vec; var i, n, j; var d, t, dx, dy, minLen; var i1, i2, i3, p1, p2, p3; var j1, j2, v1, v2,
	  k, h
	var vec1, vec2; var v, hitV; var isConvex=false; var figsVec = [], queue = [ verts ]
	
	while (queue.length) {  isConvex = true;  vec = queue[0];
	
		_.t(n = vec.length, function (i) {
		
		
			i1 = i;i2 = (i < n - 1) ? i + 1 : i + 1 - n;i3 = (i < n - 2) ? i + 2 : i + 2 - n;
