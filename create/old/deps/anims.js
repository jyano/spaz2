...
// symbols:
        ...
        (lib.gunnertron = function (mode, startPosition, loop) {
            ...
            this.timeline.addTween(cjs.Tween.get(this.instance_10).to({
                ...
                x: -79.6,
                y: -6.4
            }, 5).to({regX: 11.3, regY: -47.2, rotation: 19.7, x: -86.7, y: 4.3}, 11).to({
                regX: 11.4,
                regY: -47,
                scaleX: 1,
                scaleY: 1,
                ...
                x: -81.6,
                y: -7.6
            }, 5).to({regY: -47.1, scaleX: 1, scaleY: 1, rotation: 11.7, x: -79.6, y: -6.4}, 5).to({
                regX: 11.5,
                rotation: 0,
                x: -73.6,
                y: -14.4
                ...
                x: -70.6,
                y: -41.4
            }, 9).to({regY: -47, scaleX: 1, scaleY: 1.14, rotation: 10.8, x: -76.2, y: -37.3}, 5).to({
                regX: 11.6,
                regY: -47.2,
                scaleX: 1,
                scaleY: 1.12,
            ...
            this.timeline.addTween(cjs.Tween.get(this.instance_12).to({
                ...
                scaleY: 0.84,
                y: 14.3
            }, 11).to({scaleX: 0.92, scaleY: 1.18, y: -5.5}, 5).to({
                scaleX: 1,
                scaleY: 1,
                y: 2.1
            }, 5).wait(1).to({regX: 13, regY: 35, x: -17.6, y: 37.1}, 0).to({
                rotation: 6.2,
                x: -11.6
            }, 5).to({regY: 34.9, scaleY: 0.84, x: -13.8, y: 41.6}, 11).to({
                regY: 35,
                scaleX: 0.93,
                scaleY: 1.09,
                rotation: 6.1,
                ...
                x: -22.6,
                y: 41.1
            }, 5).to({regX: 0, regY: 0, rotation: 0, x: -30.6, y: 2.1}, 1).to({
                scaleX: 0.97,
                scaleY: 1.17,
                y: -11.2
            }, 5).wait(1).to({scaleX: 0.93, scaleY: 1.32, y: -18.2}, 9).to({
                scaleX: 1.05,
                scaleY: 1.2,
                y: -12.7
            }, 5).to({scaleX: 0.97, scaleY: 1.17, y: -11.2}, 5).wait(1));
