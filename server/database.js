...
db= X=mg=mongoose = $mg=require('mongoose')

$mg.connect("mongodb://localhost/brain", function () { $l(' - mg - ') })



var S=String, N=Number, O=Object, D=Date,
    oid = mongoose.Schema.Types.ObjectId, OIDx=function(ref){
        var g=G(arguments),
        o={
