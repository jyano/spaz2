...
// stage content:
    ...
    (lib.energyring = function (mode, startPosition, loop) {
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(11).to({_off: false}, 0).to({
            scaleX: 0.65,
            scaleY: 0.65,
            x: -17,
            y: 17.2,
    ...
    (lib.gunnertron = function (mode, startPosition, loop) {
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_10).to({
            ...
            x: -70.9,
            y: -26.2
        }, 5).to({regX: 11.5, scaleY: 1, skewX: 0, skewY: 0, x: -73.6, y: -14.4}, 5).wait(1).to({
            regX: 11.6,
            rotation: 17.2,
            x: -62.5,
            y: -18.4
        }, 5).to({rotation: 32.4, x: -63.6, y: -7.4}, 11).to({
            regX: 11.5,
            regY: -47,
            scaleX: 1,
            scaleY: 1,
            ...
            x: -58.1,
            y: -22.9
        }, 5).to({regX: 11.6, regY: -47.1, scaleX: 1, scaleY: 1, rotation: 17.2, x: -62.5, y: -18.4}, 5).to({
            regX: 11.5,
            rotation: 0,
            x: -73.6,
            y: -14.4
        }, 1).to({regX: 11.4, rotation: 11.7, x: -79.6, y: -6.4}, 5).to({
            regX: 11.3,
            regY: -47.2,
            rotation: 19.7,
            x: -86.7,
            y: 4.3
        }, 11).to({regX: 11.4, regY: -47, scaleX: 1, scaleY: 1, rotation: 4.1, x: -81.6, y: -7.6}, 5).to({
            regY: -47.1,
            scaleX: 1,
            scaleY: 1,
            rotation: 11.7,
            x: -79.6,
            y: -6.4
        }, 5).to({regX: 11.5, rotation: 0, x: -73.6, y: -14.4}, 1).to({
            regX: 11.6,
            regY: -47.2,
            scaleY: 1.12,
            rotation: 12.5,
            x: -71.5,
            y: -34.5
        }, 5).wait(1).to({regX: 11.5, regY: -47.1, scaleY: 1.18, rotation: 8.8, x: -70.6, y: -41.4}, 9).to({
            regY: -47,
            scaleX: 1,
            scaleY: 1.14,
            rotation: 10.8,
            x: -76.2,
            y: -37.3
        }, 5).to({regX: 11.6, regY: -47.2, scaleX: 1, scaleY: 1.12, rotation: 12.5, x: -71.5, y: -34.5}, 5).wait(1));
        // head
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_11).to({
            ...
            scaleY: 1.04,
            y: -27.7
        }, 11).to({scaleX: 0.97, scaleY: 1.23, y: -65.1}, 5).to({
            scaleX: 1,
            scaleY: 1,
            y: -43.5
        }, 5).wait(1).to({regX: 6, regY: 20, x: -26.3, y: -23.4}, 0).to({
            regY: 20.1,
            rotation: -2.5,
            x: -13.3,
            y: -22.4
        }, 5).to({scaleY: 0.91, x: -14.3, y: -8.4}, 11).to({
            regY: 20,
            scaleX: 0.91,
            scaleY: 1.26,
            rotation: -2.4,
            x: -13.9,
            y: -28.2
        }, 5).to({regY: 20.1, scaleX: 1, scaleY: 1, rotation: -2.5, x: -13.3, y: -22.4}, 5).to({
            regY: 20,
            rotation: 0,
            x: -26.3,
            y: -23.4
        }, 1).to({regY: 19.9, rotation: 2.5, x: -39.3, y: -19.5}, 5).to({
            scaleX: 1.06,
            scaleY: 0.89,
            rotation: -1.8,
            x: -42.3,
            y: -7.4
        }, 11).to({regY: 20, scaleX: 0.9, scaleY: 1.09, rotation: 0.5, x: -38.6, y: -23.8}, 5).to({
            regY: 19.9,
            scaleX: 1,
            scaleY: 1,
            rotation: 2.5,
            x: -39.3,
            y: -19.5
        }, 5).to({regX: 0, regY: 0, rotation: 0, x: -32.4, y: -43.5}, 1).to({
            scaleX: 0.94,
            scaleY: 1.34,
            y: -75.5
        }, 5).wait(1).to({scaleX: 0.88, scaleY: 1.47, y: -86.5}, 9).to({
            scaleX: 1.04,
            scaleY: 1.13,
            x: -33.4,
            y: -64.7
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_12).to({
            ...
            scaleY: 0.84,
            y: 14.3
        }, 11).to({scaleX: 0.92, scaleY: 1.18, y: -5.5}, 5).to({scaleX: 1, scaleY: 1, y: 2.1}, 5).wait(1).to({
            regX: 13,
            regY: 35,
            x: -17.6,
            y: 37.1
        }, 0).to({rotation: 6.2, x: -11.6}, 5).to({regY: 34.9, scaleY: 0.84, x: -13.8, y: 41.6}, 11).to({
            regY: 35,
            scaleX: 0.93,
            scaleY: 1.09,
            rotation: 6.1,
            x: -12.4,
            y: 37.8
        }, 5).to({scaleX: 1, scaleY: 1, rotation: 6.2, x: -11.6, y: 37.1}, 5).to({
            rotation: 0,
            x: -17.6
        }, 1).to({regY: 34.9, rotation: -3.5, x: -22.6, y: 41.1}, 5).to({
            regX: 12.8,
            scaleX: 1.09,
            scaleY: 0.89,
            rotation: -7.8,
            ...
            x: -22.4,
            y: 41.5
        }, 5).to({regX: 13, regY: 34.9, scaleX: 1, scaleY: 1, rotation: -3.5, x: -22.6, y: 41.1}, 5).to({
            regX: 0,
            regY: 0,
            rotation: 0,
            x: -30.6,
            y: 2.1
        }, 1).to({scaleX: 0.97, scaleY: 1.17, y: -11.2}, 5).wait(1).to({
            scaleX: 0.93,
            scaleY: 1.32,
            y: -18.2
        }, 9).to({scaleX: 1.05, scaleY: 1.2, y: -12.7}, 5).to({scaleX: 0.97, scaleY: 1.17, y: -11.2}, 5).wait(1));
        // butt
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_13).to({
            ...
            x: -20,
            y: 44.1
        }, 11).to({regY: -9.9, scaleX: 0.95, scaleY: 1.2, x: -18.7, y: 34.2}, 5).to({
            scaleX: 1,
            scaleY: 1,
            rotation: 7.8,
            x: -20,
            y: 41.1
        }, 5).wait(1).to({regX: 0.2, rotation: 8.5, x: -20.1}, 0).to({rotation: 25.2}, 5).to({
            regY: -9.8,
            scaleY: 0.86,
            x: -21.9,
            y: 45.1
        }, 11).to({scaleX: 0.92, scaleY: 1.02, rotation: 25.1, x: -19.8, y: 40.5}, 5).to({
            regY: -9.9,
            scaleX: 1,
            scaleY: 1,
            rotation: 25.2,
            x: -20.1,
            y: 41.1
        }, 5).to({rotation: 8.5}, 1).to({regX: 0.3, rotation: -5.9, x: -20, y: 41.2}, 5).to({
            regY: -10,
            scaleX: 1.11,
            scaleY: 0.83,
            rotation: -16.2,
            x: -19.4,
            y: 46.4
        }, 11).to({scaleX: 1.05, scaleY: 0.93, rotation: -10.3, x: -19.8, y: 43.4}, 5).to({
            regY: -9.9,
            scaleX: 1,
            scaleY: 1,
            rotation: -5.9,
            x: -20,
            y: 41.2
        }, 5).to({regX: 0.2, rotation: 8.5, x: -20.1, y: 41.1}, 1).to({
            regY: -9.8,
            scaleX: 0.86,
            scaleY: 1.22,
            rotation: 4.8,
            x: -19.9,
            y: 34.6
        }, 5).wait(1).to({regY: -9.9, scaleX: 0.75, scaleY: 1.5, x: -19.8, y: 30.5}, 9).to({
            regX: 0.3,
            scaleX: 0.96,
            scaleY: 1.21,
            y: 32.8
        }, 5).to({regX: 0.2, regY: -9.8, scaleX: 0.86, scaleY: 1.22, x: -19.9, y: 34.6}, 5).wait(1));
        // gunarm
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_14).to({
            ...
            skewY: 2.3,
            y: 2.4
        }, 11).to({scaleY: 1.24, skewX: 2.9, skewY: 3.2, x: 17.6, y: -28.4}, 5).to({
            scaleY: 1,
            rotation: -4,
            skewX: 0,
            skewY: 0,
            x: 18.2,
            y: -18
        }, 5).wait(1).to({rotation: -4.3}, 0).to({x: 36.2, y: -12}, 5).to({
            regX: -43.4,
            rotation: -8.5,
            x: 33.2,
            y: 1.8
        }, 11).to({rotation: 0.2, x: 34.7, y: -19}, 5).to({
            regX: -43.3,
            rotation: -4.3,
            x: 36.2,
            y: -12
        }, 5).to({x: 18.2, y: -18}, 1).to({rotation: -0.1, x: 12.2, y: -16}, 5).to({
            regX: -43.4,
            rotation: -6.8,
            x: 11.1,
            y: -11
        }, 11).to({rotation: 6, x: 10.7, y: -18.8}, 5).to({
            regX: -43.3,
            rotation: -0.1,
            x: 12.2,
            y: -16
        }, 5).to({rotation: -4.3, x: 18.2, y: -18}, 1).to({
            regY: -8.9,
            rotation: -11,
            x: 16.3,
            y: -36
        }, 5).wait(1).to({rotation: 1.5, x: 16.2, y: -46}, 9).to({
            rotation: -5.6,
            x: 21.3,
            y: -38.3
        }, 5).to({rotation: -11, x: 16.3, y: -36}, 5).wait(1));
        // energy
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_15).to({_off: true}, 22).wait(5).to({
            skewX: 13,
            skewY: 6.2,
            x: -32.1,
            y: 67.8,
            _off: false
        }, 0).to({_off: true}, 22).wait(5).to({
            scaleX: 1.01,
            skewX: -45.6,
            skewY: -49.2,
            x: -8.1,
            _off: false
        }, 0).to({_off: true}, 22).wait(26));
    }).prototype = p = new cjs.MovieClip();
    p.nominalBounds = rect = new cjs.Rectangle(-110.5, -75.5, 224, 212.1);
    p.frameBounds = [rect, new cjs.Rectangle(-110.7, -74.2, 224.4, 213.2), 
    new cjs.Rectangle(-110.8, -72.9, 224.8, 214.3), new cjs.Rectangle(-110.9, -71.6, 225.1, 215.2),
     new cjs.Rectangle(-110.9, -70.2, 225.4, 216.3), new cjs.Rectangle(-110.8, -69, 225.5, 217.5), 
     new cjs.Rectangle(-110.8, -67.6, 225.7, 218.5), new cjs.Rectangle(-110.7, -66.3, 225.8, 219.6), 
     new cjs.Rectangle(-110.5, -64.9, 225.7, 220.6), new cjs.Rectangle(-110.2, -63.6, 225.6, 221.6), 
     new cjs.Rectangle(-110, -62.3, 225.5, 222.6), new cjs.Rectangle(-109.5, -61, 221.2, 223.8), 
     new cjs.Rectangle(-105.5, -69.8, 217, 208.3), new cjs.Rectangle(-109.3, -78.4, 220.8, 219.6), 
     new cjs.Rectangle(-113.4, -87.2, 224.8, 231), new cjs.Rectangle(-117.9, -95.8, 229.3, 242.4),
      new cjs.Rectangle(-108.3, -104.5, 219.7, 253.9), new cjs.Rectangle(-107.2, -98.7, 220, 250.6), 
      new cjs.Rectangle(-110.4, -92.9, 224.3, 247.5), new cjs.Rectangle(-113.3, -87.1, 228.1, 244.5),
       new cjs.Rectangle(-116.4, -81.3, 232.2, 241.4), new cjs.Rectangle(-110.5, -75.5, 223.9, 238.3), 
       new cjs.Rectangle(-110.5, -75.5, 224, 151.3), new cjs.Rectangle(-113.5, -75.7, 230.6, 153),
        new cjs.Rectangle(-116.6, -75.9, 237.3, 154.6), new cjs.Rectangle(-119.4, -76, 243.7, 156.2), 
        new cjs.Rectangle(-122.1, -76.2, 250, 157.6), new cjs.Rectangle(-124.6, -76.5, 256.1, 196.5),
         new cjs.Rectangle(-124.3, -75, 255.7, 196.9), new cjs.Rectangle(-126.3, -73.2, 257.7, 197), 
         new cjs.Rectangle(-128.6, -71.5, 259.9, 197), new cjs.Rectangle(-130.6, -69.7, 261.8, 197.1), 
         new cjs.Rectangle(-132.8, -68, 264, 197.4), new cjs.Rectangle(-134.7, -66.2, 265.7, 197.4),
          new cjs.Rectangle(-136.8, -64.4, 267.8, 197.6), new cjs.Rectangle(-138.9, -62.6, 269.8, 197.8), 
          new cjs.Rectangle(-140.7, -61, 271.5, 197.8), new cjs.Rectangle(-142.7, -59.2, 273.4, 198), 
          new cjs.Rectangle(-143.3, -57.6, 273.6, 201.6), new cjs.Rectangle(-138.4, -65.8, 269.9, 187.1), 
          new cjs.Rectangle(-137.7, -73.9, 270.3, 197.4), new cjs.Rectangle(-136.8, -82, 270.4, 207.6), 
          new cjs.Rectangle(-135.7, -90.1, 270.2, 217.8), new cjs.Rectangle(-119.9, -95.6, 247.5, 225.6), 
          new cjs.Rectangle(-118.3, -91.8, 246.7, 223.7), new cjs.Rectangle(-119.2, -87.9, 248.5, 222.1), 
          new cjs.Rectangle(-120.1, -84, 250.2, 220.4), new cjs.Rectangle(-121, -80.2, 251.9, 218.7),
           new cjs.Rectangle(-124.6, -76.5, 256.1, 217.1), new cjs.Rectangle(-110.5, -75.5, 224, 151.3), 
           new cjs.Rectangle(-115.3, -75, 227.9, 153), new cjs.Rectangle(-119.9, -74.7, 231.7, 154.5),
            new cjs.Rectangle(-125, -74.4, 235.9, 156), new cjs.Rectangle(-129.4, -74, 239.4, 157.2),
             new cjs.Rectangle(-134, -73.7, 239.3, 204), new cjs.Rectangle(-133.9, -72.1, 239.3, 204.4),
              new cjs.Rectangle(-135.6, -70.7, 241.3, 205), new cjs.Rectangle(-137.4, -69.4, 243.4, 205.6),
               new cjs.Rectangle(-139.2, -68, 245.4, 206.2), new cjs.Rectangle(-141, -66.7, 247.5, 207),
                new cjs.Rectangle(-142.7, -65.2, 249.4, 207.4), new cjs.Rectangle(-144.4, -63.7, 251.3, 207.9),
                 new cjs.Rectangle(-146, -62.4, 253, 208.6), new cjs.Rectangle(-147.7, -61, 255, 209.2), 
                 new cjs.Rectangle(-149.4, -59.7, 256.9, 209.8), new cjs.Rectangle(-151.7, -55, 259.3, 207.2),
                  new cjs.Rectangle(-148.2, -61.4, 257, 193.3), new cjs.Rectangle(-147.5, -67.5, 257.1, 201.6),
                   new cjs.Rectangle(-146.5, -73.6, 256.7, 209.9), new cjs.Rectangle(-145.3, -79.4, 256, 218.1), new cjs.Rectangle(-124.8, -81.2, 229.7, 222.2), new cjs.Rectangle(-126, -79.5, 232.3, 222.6), new cjs.Rectangle(-128, -78.1, 235.4, 223.5), new cjs.Rectangle(-129.9, -76.5, 238.5, 224.3), new cjs.Rectangle(-131.8, -75.2, 241.4, 225.2), new cjs.Rectangle(-134, -73.7, 239.3, 225.9), new cjs.Rectangle(-110.5, -75.5, 224, 151.3), new cjs.Rectangle(-114.2, -84.1, 228, 160.7), new cjs.Rectangle(-117.8, -92.7, 231.8, 170.1), new cjs.Rectangle(-121.5, -101.3, 235.8, 179.6), new cjs.Rectangle(-125.4, -109.9, 239.9, 189), rect = new cjs.Rectangle(-129.5, -118.5, 243.6, 192.2), rect, new cjs.Rectangle(-127.4, -120.2, 242.3, 194.5), new cjs.Rectangle(-127.3, -121.8, 243, 196.9), new cjs.Rectangle(-127.3, -123.5, 243.7, 199.1), new cjs.Rectangle(-127.2, -125.2, 244.2, 201.5), new cjs.Rectangle(-127.3, -126.8, 244.9, 203.7), new cjs.Rectangle(-127.2, -128.5, 245.3, 206), new cjs.Rectangle(-127.1, -130.2, 245.7, 208.3), new cjs.Rectangle(-127.1, -131.8, 246, 210.5), new cjs.Rectangle(-123.4, -133.5, 232.8, 211.7), new cjs.Rectangle(-123.3, -127, 234.6, 204), new cjs.Rectangle(-125.2, -120.5, 238.3, 196.4), new cjs.Rectangle(-127.1, -114, 242, 188.7), new cjs.Rectangle(-128.5, -107.5, 245.2, 181.1), new cjs.Rectangle(-131.7, -101, 248.8, 173.1), new cjs.Rectangle(-129.3, -104.5, 246, 177.1), new cjs.Rectangle(-128.8, -108, 245, 181), new cjs.Rectangle(-128.6, -111.5, 244.4, 184.9), new cjs.Rectangle(-128.1, -115, 243.3, 188.9), new cjs.Rectangle(-129.5, -118.5, 243.6, 192.2)];
...
GUNNERTRON = function () {
    ...
    p= $.p().html(
        'Using <code>SpriteSheetBuilder</code> to create <code>SpriteSheet</code><br>' +
        'instances asynchronously at run time from a <code>MovieClip</code> instance.'
    )


    p.A(
        $.p('Note that a spritesheet of this animation (at scale=1) is 2.5MB, whereas'),
        $.p('the "over the wire" (gzipped) size of the movieclip is only 19kb+ '),
        $.p('and it can be scaled dynamically at runtime.')
    )

    $(' <header class="EaselJS"><h1>SpriteSheetBuilder & MovieClip</h1>').A(
...
GUNN = function () {
	...
	mc = new lib.gunnertron();
	mc.sTf(
	100+(mc.nW()*scale)/2,  100, scale, scale )
	st.A(mc);
	lb1=st._A( new cjs.Text("MovieClip (vector)", "14px Arial", "#111")).tA("center")
	.sTf(mc.x, 30);
 	T.setFPS(30); T.on("tick", st)
}
function newOld(){
	$.c2 = function (w, y) {
		var c = $.c(w || 960, h || 200)
...
function _pre() {
	...
	dO.nW =function(){ return this.nominalBounds.width}
...
GUN = function () {
	...
	cv = $("#canvas")[0]
	st = new cjs.S(cv)
	mc = new lib.gunnertron().XY(300,240)
	//mc.sTf(100 + (mc.nW() * scale) / 2, 100, scale, scale)
	st.A(mc);
	T.setFPS(30);
	T.on("tick", st)
...
dw = function () {mc.gotoAndStop('RoboDown')}
mdw = function () {mc.gotoAndStop('RoboMoveDown')} 
fw = function () {mc.gotoAndStop('RoboForward')}
mfw = function () {
